    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new SwitchDrawerItem().withName("Switch").withIcon(GoogleMaterial.Icon.gmd_settings).withChecked(true).withOnCheckedChangeListener(onCheckedChangeListener),
                        new SwitchDrawerItem().withName("Switch2").withIcon(GoogleMaterial.Icon.gmd_settings).withChecked(true).withOnCheckedChangeListener(onCheckedChangeListener),
                        new ToggleDrawerItem().withName("Toggle").withIcon(GoogleMaterial.Icon.gmd_settings).withChecked(true).withOnCheckedChangeListener(onCheckedChangeListener)
